...
if($search == ""){
  ...
  <header>
	...
	<td style="text-align:center;">
		<a href=used_board.php?num=<?=$num?>>
		<img src="./data/<?=$file_copied?>" width="200px" height="200px"><br>
		<?=$product_name?><br>

		<?=number_format($price)?>원<br>
    <?=$id?><br>
		</td>
		<?php
		if(($i+1)%4==0){?>
	...
	<?php
		...
		{
			$new_page = $page-1;
			echo "<li><a href='used_index.php?page=$new_page'>◀ 이전</a> </li>";
		}
		else
			echo "<li>&nbsp;</li>";
	   	...
	   	for ($i=1; $i<=$total_page; $i++)
	   	{
			...
			{
				echo "<li><a href='used_index.php?page=$i'> $i </a><li>";
			}
	   	}
	   	if ($total_page>=2 && $page != $total_page)
	   	{
			$new_page = $page+1;
			echo "<li> <a href='used_index.php?page=$new_page'>다음 ▶</a> </li>";
		}
		else
			echo "<li>&nbsp;</li>";
	?>
